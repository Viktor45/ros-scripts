...
<!-- TOC -->
* [Скрипт Cloudflare DDNS для MikroTik](#скрипт-cloudflare-ddns-для-mikrotik)
  * [Возможности](#возможности)
  * [Предварительные требования](#предварительные-требования)
  * [Установка](#установка)
    * [Шаг 1: Включите IP Cloud](#шаг-1-включите-ip-cloud)
    * [Шаг 2: Получите учетные данные API Cloudflare](#шаг-2-получите-учетные-данные-api-cloudflare)
    * [Шаг 3: Получите Zone ID и Record ID](#шаг-3-получите-zone-id-и-record-id)
      * [Получение Zone ID:](#получение-zone-id)
      * [Получение Record ID:](#получение-record-id)
    * [Шаг 4: Настройте скрипт](#шаг-4-настройте-скрипт)
    * [Шаг 5: Добавьте скрипт в MikroTik](#шаг-5-добавьте-скрипт-в-mikrotik)
    * [Шаг 6: Создайте планировщик](#шаг-6-создайте-планировщик)
  * [Примеры конфигурации](#примеры-конфигурации)
    * [Только IPv4](#только-ipv4)
    * [Только IPv6](#только-ipv6)
    * [Несколько доменов (IPv4 и IPv6)](#несколько-доменов-ipv4-и-ipv6)
    * [Один домен — двойной стек (записи A + AAAA)](#один-домен--двойной-стек-записи-a--aaaa)
  * [Проверка](#проверка)
    * [Проверка логов скрипта](#проверка-логов-скрипта)
    * [Ручной тестовый запуск](#ручной-тестовый-запуск)
    * [Проверка глобальных переменных](#проверка-глобальных-переменных)
  * [Диагностика](#диагностика)
    * [Скрипт не запускается](#скрипт-не-запускается)
    * [Ошибки API](#ошибки-api)
    * [IPv6 не работает](#ipv6-не-работает)
    * [Обновления не происходят](#обновления-не-происходят)
  ...
  * [Настройка](#настройка)
    ...
    * [Отключение задержки ограничения частоты](#отключение-задержки-ограничения-частоты)
  * [Удаление](#удаление)
  * [Лицензия](#лицензия)
