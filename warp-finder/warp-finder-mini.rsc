# This is special tiny version for some countries :)

# Initialize global arrays using working method
:global ipPrefixes [:toarray "162.159.192.,162.159.193.,162.159.195."];
...
:local wgInterface "your-cloudflare-interface";
...
:while (($attempt < $maxAttempts) && (!$endpointFound)) do={
    ...
    # Generate random IP part (1-10)
    [$debugPrint] ("DEBUG: Generating random IP part");
    :local randomIPPart (($seed * 17 + $attempt) % 10);
