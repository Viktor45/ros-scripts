...
* [🛠️ ros-scripts](#-ros-scripts)
  ...
  * [🚀 Установка](#-установка)
    * [Метод 1: Через WebFig/WinBox (рекомендуется)](#метод-1-через-webfigwinbox-рекомендуется)
    * [Метод 2: Через терминал/SSH](#метод-2-через-терминалssh)
    * [Метод 3: Загрузка файла](#метод-3-загрузка-файла)
