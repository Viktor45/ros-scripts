...
<!-- TOC -->
* [🔄 MikroTik DNS Resolution Script](#-mikrotik-dns-resolution-script)
  ...
  * [⚙️ Configuration](#-configuration)
    ...
    * [IP Version Selection](#ip-version-selection)
    * [IPv4 Address Lists Configuration](#ipv4-address-lists-configuration)
    * [IPv6 Address Lists Configuration](#ipv6-address-lists-configuration)
  * [🚀 Usage](#-usage)
  ...
  * [📖 Examples](#-examples)
    * [Example 1: IPv4 Only Setup](#example-1-ipv4-only-setup)
    * [Example 2: IPv6 Only Setup](#example-2-ipv6-only-setup)
    * [Example 3: Dual Stack (IPv4 + IPv6)](#example-3-dual-stack-ipv4--ipv6)
    * [Example 4: Multi-Network Dual Stack](#example-4-multi-network-dual-stack)
    * [Example 5: Security Monitoring with Separate DNS](#example-5-security-monitoring-with-separate-dns)
  * [🐛 Troubleshooting](#-troubleshooting)
    * [Enable Debug Logging](#enable-debug-logging)
    * [Common Issues](#common-issues)
  * [🌐 IPv6 Best Practices](#-ipv6-best-practices)
    * [Naming Convention](#naming-convention)
    * [DNS Server Selection](#dns-server-selection)
    * [Address List Organization](#address-list-organization)
