...
<!-- TOC -->
* [🛡️ Скрипт обнаружения и блокировки аномальных соединений MikroTik](#-скрипт-обнаружения-и-блокировки-аномальных-соединений-mikrotik)
  * [📋 Содержание](#-содержание)
  * [✨ Возможности](#-возможности)
  * [🔍 Принцип работы](#-принцип-работы)
  * [📦 Требования](#-требования)
  * [🚀 Установка](#-установка)
    * [Метод 1: Веб-интерфейс (WinBox/WebFig)](#метод-1-веб-интерфейс-winboxwebfig)
    * [Метод 2: Терминал/SSH](#метод-2-терминалssh)
    * [Метод 3: Планировщик (автозапуск)](#метод-3-планировщик-автозапуск)
  * [⚙️ Конфигурация](#-конфигурация)
    * [Основные настройки](#основные-настройки)
    * [Пороги обнаружения](#пороги-обнаружения)
    * [Блокировка и производительность](#блокировка-и-производительность)
  ...
  * [📖 Использование](#-использование)
    ...
    * [Создание allowlist](#создание-allowlist)
    * [Просмотр заблокированных IP](#просмотр-заблокированных-ip)
    * [Ручное удаление заблокированного IP](#ручное-удаление-заблокированного-ip)
    * [Очистка всех блокировок](#очистка-всех-блокировок)
  * [🔥 Правила фаервола](#-правила-фаервола)
    * [Рекомендуемые правила](#рекомендуемые-правила)
  * [📊 Мониторинг и логи](#-мониторинг-и-логи)
    * [Просмотр логов](#просмотр-логов)
    * [Мониторинг логов в реальном времени](#мониторинг-логов-в-реальном-времени)
    * [Пример вывода логов](#пример-вывода-логов)
    * [Статистика](#статистика)
  * [🔧 Диагностика](#-диагностика)
    * [Скрипт не запускается](#скрипт-не-запускается)
    * [IP не блокируются](#ip-не-блокируются)
    * [Высокое использование CPU](#высокое-использование-cpu)
    * [Блокировка легитимного трафика](#блокировка-легитимного-трафика)
  * [⚡ Производительность](#-производительность)
    * [Влияние на ресурсы](#влияние-на-ресурсы)
