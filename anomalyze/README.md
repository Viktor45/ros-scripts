...
<!-- TOC -->
* [🛡️ MikroTik Connection Anomaly Detection & Blocking Script](#-mikrotik-connection-anomaly-detection--blocking-script)
  * [📋 Table of Contents](#-table-of-contents)
  * [✨ Features](#-features)
  * [🔍 How It Works](#-how-it-works)
  * [📦 Requirements](#-requirements)
  * [🚀 Installation](#-installation)
    * [Method 1: Web Interface (WinBox/WebFig)](#method-1-web-interface-winboxwebfig)
    * [Method 2: Terminal/SSH](#method-2-terminalssh)
    * [Method 3: Scheduler (Auto-Start)](#method-3-scheduler-auto-start)
  * [⚙️ Configuration](#-configuration)
    * [Core Settings](#core-settings)
    * [Detection Thresholds](#detection-thresholds)
    * [Blocking & Performance](#blocking--performance)
    * [Advanced Options](#advanced-options)
    * [Configuration Examples](#configuration-examples)
  * [📖 Usage](#-usage)
    * [Start the Script](#start-the-script)
    * [Stop the Script](#stop-the-script)
    * [Create Allowlist](#create-allowlist)
    * [View Blocked IPs](#view-blocked-ips)
    * [Manually Remove Blocked IP](#manually-remove-blocked-ip)
  ...
  * [🔧 Troubleshooting](#-troubleshooting)
    ...
    * [No IPs Being Blocked](#no-ips-being-blocked)
    * [High CPU Usage](#high-cpu-usage)
    * [Legitimate Traffic Being Blocked](#legitimate-traffic-being-blocked)
